...
namespace ReactiveDomain.Messaging.Bus
{
    ...
    public class QueuedHandlerDiscarding : IQueuedHandler, IHandle<Message>, IPublisher, IMonitoredQueue, IThreadSafePublisher
    {
        ...
        public QueuedHandlerDiscarding(IHandle<Message> consumer,
                                 string name,
